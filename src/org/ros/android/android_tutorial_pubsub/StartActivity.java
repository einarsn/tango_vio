...
public class StartActivity extends Activity implements View.OnClickListener {
    public static final String KEY_MOTIONTRACKING_AUTORECOVER = 
            "org.ros.android.android_tutorial_pubsub.useautorecover";
    ...
    private void startMotionTracking() {
        ...
        */
        Intent startRos = new Intent(this, MainActivity.class);
        startRos.putExtra(KEY_MOTIONTRACKING_AUTORECOVER, mUseAutoReset);
